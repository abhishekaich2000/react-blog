  ...
  return (
    <div className="singlePost">
      <div className="singlePostWrapper">
        <img src={public_folder + post.photo} alt="" className="singlePostImg" />
        {
        ...
        <div className="singlePostInfo">
          <span className="singlePostAuthor">Author: <b> <Link to={`/?user=${post.username}`} className="link">{post.username}</Link>
          </b></span>
